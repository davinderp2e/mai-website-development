pipeline {
	...
	environment {
		DEV_ECR_URL = '408153089286.dkr.ecr.ap-south-1.amazonaws.com/mai-website-dev'
		DEV_ENV = 'dev' 
        QA_ECR_URL = '408153089286.dkr.ecr.ap-south-1.amazonaws.com/mai-website-qa'
		QA_ENV = 'qa'
        STG_ECR_URL = '408153089286.dkr.ecr.ap-south-1.amazonaws.com/mai-website-stg'
		STG_ENV = 'stg'
	...
	stages {
		...
		stage('STG_DEPLOY') {
			...
			steps {
				...
				sh "aws eks --region me-central-1 update-kubeconfig --name smart-stg"
